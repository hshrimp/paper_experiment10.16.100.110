...
def main():
    ...
    parser.add_argument('--vocab_file', default='/home/wshong/Desktop/embedding/wordvecs.vcb', type=str)
    parser.add_argument('--vectors_file', default='/home/wshong/Desktop/embedding/wordvecs.txt', type=str)
    ...
    with open(args.vectors_file, 'r') as f:
        ...
        for line in f:
            ...
            vectors[words[num]] = [float(x) for x in vals[:]]
            num += 1
